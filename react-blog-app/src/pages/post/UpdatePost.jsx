...
const UpdatePost = () => {
   ...
   if(postId){
    const getPost =async ()=>{
      try {
        ...
        //api request
        const response = await axios.get(`/posts/${categoryId}`);
  ...
  //function to save updated post data
  ...
  const handleFileChange = async (e)=>{
    ...
    if(type === 'image/png' || type === 'image/jpg' || type === 'image/jpeg'){
      ...
      setExtensionError("Only png, jgp or jpeg type file allowed.")
    }
  }
